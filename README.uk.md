...
| **ML Розворот** | Автозакриття якщо ML розвернувся з >65% впевненістю (навіть в збитку) + миттєвий flip |
| **Health Check** | Перевіряє RSI, ADX, volume кожен скан: HEALTHY → WEAKENING → CLOSE_EARLY |
| **Position Flip** | При ML розвороті: закрити SHORT → одразу відкрити LONG (без затримки 5хв) |
